...
const APK_URL = '/downloads/ebisu-tracker-1.0.2.apk';
    ...
    return <Layout showParticles={false}>
        ...
        <main className={styles.page}>
            <section className={styles.card}>
                ...
                <div className={styles.meta}><span>Version 1.0.2</span><span>2.9 MB</span><span>Android 5.1 or later</span></div>
                ...
                <p className={styles.checksum}>SHA-256: <code>25f0ec2524d156c2a2691a19cdf569567e2ed95462dd2947894fe835c99d3366</code></p>
